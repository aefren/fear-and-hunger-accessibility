 ...
 * offset, volume = distance). Goes silent once picked up. Pings every two seconds,
 * or once a second within a few tiles. No toggle. Sibling of ContainerSonar for loose
 * floor loot.
 ...
 *
 * @param Far Interval
 * @desc Frames between pings for a distant item. 120 frames = 2 seconds.
 * @type number
 * @default 120
 *
 * @param Near Interval
 * @desc Frames between pings for a near item (<= Near Threshold). 60 = one second.
 * @type number
 * @default 60
 *
 ...
 * Cadence is per item: every two seconds normally, once a second once it is within
