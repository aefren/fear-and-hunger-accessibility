 ...
 * offset, volume = distance). Pings every two seconds, or once a second within
 ...
 *
 * @param Far Interval
 * @desc Frames between pings for a distant enemy. 120 frames = 2 seconds.
 * @type number
 * @default 120
 *
 * @param Near Interval
 * @desc Frames between pings for a near enemy (<= Near Threshold). 60 = one second.
 * @type number
 * @default 60
 *
 ...
 * Cadence is per enemy: every two seconds normally, once a second once the enemy
...
(function () {
    ...
    function ping(dx, dy, dist) {
        ...
        // Volume: louder near (60) fading to quiet far (20) by ~30 tiles.
